          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <li>
                <NavLink
                  to="/"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-black dark:hover:bg-meta-4 ${
                    (pathname === '#' || pathname.includes('#')) &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                  onMouseOver={(e) => {
                    e.currentTarget.style.backgroundColor = '#50abe3';
                    e.currentTarget.style.color = 'white';
                  }}
                  onMouseOut={(e) => {
                    e.currentTarget.style.backgroundColor = 'transparent';
